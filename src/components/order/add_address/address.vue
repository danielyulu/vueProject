<template>
    <div id="a_address">
        ...
        <div class="ad_main">
            ...
            <div id="prop">
                 <mu-popup  position="bottom" popupClass="demo-popup-bottom" :open="bottomPopup" @close="close" class="m_top">
                 <div class="p_title">
                   
                    <span @click="close('bottom')">关闭</span>
    ...
    export default{
         data () {
          ...
          methods: {
            ...
            finish(){
                this.area=this.addressProvince+' ' +this.addressCity;
                this.bottomPopup = false
            },
